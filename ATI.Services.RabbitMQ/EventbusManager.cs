...
public class EventbusManager : IDisposable, IInitializer
{
    ...
    private readonly MetricsFactory _inMetricsFactory = MetricsFactory.CreateRabbitMqMetricsFactory(RabbitMetricsDirection.In, nameof(EventbusManager), additionalSummaryLabels: "client_name");
