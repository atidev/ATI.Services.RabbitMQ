    ...
    public class EventbusManager : IDisposable, IInitializer
    {
        ...
        public void SetTraceHeadersFromActivity(MessageProperties properties)
        {
            ...
            if (Activity.Current.TraceId != default)
                properties.Headers.Add(MessagePropertiesNames.TraceId, Activity.Current.TraceId);

            if (Activity.Current.SpanId != default)
                properties.Headers.Add(MessagePropertiesNames.SpanId, Activity.Current.SpanId);
