...
public class RmqTopology
{
    ...
    private string GetEventbusExclusiveQueueName(string rabbitService, string exchange, string operation,
    ...
    private string EventbusQueueNameTemplate(string rabbitService, string routingKey, string operation,
        string customQueueName)
    {
